                ...
                <table id="category" class="table table-bordered table-striped">
                    ...
                    @foreach($category as $categories)
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-info" role="button" title="{{__('category.edit').$categories->name }}" data-toggle="modal" data-target="#edit"><a href="{{ route('admin.category.edit', ['category' => $categories->id]) }}">{{ __('category.edit') }}</a></button>
